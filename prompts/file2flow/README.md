...
3. **`02-source-preprocess.md`** → 节点候选 / dossier（输入 = 转述全文）
4. **`03-complete-candidate-points.md`** → 补全 candidate 前置关系（输入 = 原文 + 转述 + candidatePoints）
5. **`04-graph-from-source.md`** → 构图 → `normalizeAiGraph`
