    ...
    <div style={{ display: "flex", flexDirection: "column", height: "100%", overflow: "hidden", background: "var(--canvas-bg)" }}>
      <div style={{
        ...
        flexShrink: 0,
          ...
          <span style={{ color: "var(--ink-500)", fontSize: 12 }}>{doc.name}</span>
      </div>
      ...
      <div style={{ flex: 1, minHeight: 0, overflow: "hidden", position: "relative" }}>
        ...
        <div className="doc-secnav-panel">
          <nav className="doc-secnav">
            <div className="doc-secnav-heading">On this page</div>
            <div className="doc-secnav-list" role="list">
            {NAV_ITEMS.map(({ id, label }) => {
              ...
              return (
                <button
                  ...
                  role="listitem"
                  onClick={() => scrollTo(id)}
                  className={`doc-secnav-item${active ? " active" : ""}`}
                >
                  {label}
                </button>
              );
